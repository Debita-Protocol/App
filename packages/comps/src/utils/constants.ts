...
export const CASH_LABEL_FORMATS = {
  ...
  WETH: { symbol: "Ξ", prepend: true, displayDecimals: 4, icon: EthIcon },
...
export const MODAL_POOL_COLLATERAL_ACTION: string = "MODAL_POOL_COLLATERAL_ACTION";
export const MODAL_POOL_BORROWER_ACTION = "MODAL_POOL_BORROWER_ACTION";
