...
//onlyValidator 
  ...
  function closeShort(
    ...
    uint256 returned_collateral = shortZCB.trustedClose(msg.sender, close_amount, min_collateral_out);  
    ...
    BondingCurve(controller.getZCB_ad(marketId)).trustedDiscountedBurn(shortZCBs[marketId], close_amount);
