...
export const PositionTable = ({
  ...
  console.log('vaultBalances', zcbBalances, vaultBalances); 
  ...
  return (
    <>
      <div className={Styles.PositionTable}>
        ...
        {<PositionRow portfolio = {portfolioPage} claimable = {true} key={String(0)} hasLiquidity={true} outcome={"longZCB"} quantity={"lb"} averagePricePurchased={"0.9"} address={"."}/>}
        {<PositionRow portfolio = {portfolioPage} claimable = {true} key={String(1)} hasLiquidity={true} outcome={"shortZCB"} quantity={"sb"} averagePricePurchased={"0.1"} address={"."}/>}
